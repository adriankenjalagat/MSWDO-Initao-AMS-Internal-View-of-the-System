  ...
  <div class="modal-overlay">
    <div class="modal-container">
      ...
      <div v-if="showSuccess" class="success-banner">
        ...
        <div>
          <p class="success-title">Record Saved. Redirecting to Assessment...</p>
        </div>
      </div>
          ...
          <div class="form-section">
            ...
            <div class="grid-3">
              ...
              <div class="form-field">
                ...
                <p v-if="errors.sex" class="error-message">
                  <svg class="error-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  {{ errors.sex }}
            ...
            <div class="grid-4">
              ...
              <div class="form-field">
                ...
                <input
                  ...
                  placeholder=""
                />
                <p v-if="errors.barangay" class="error-message">
                  <svg class="error-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  {{ errors.barangay }}
          ...
          <div class="form-section">
            ...
            <div class="grid-2">
              <div class="form-field">
                ...
                <p v-if="errors.civilStatus" class="error-message">
                  <svg class="error-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  {{ errors.civilStatus }}
          ...
          <div class="form-section">
            ...
            <div class="grid-2">
              <div class="form-field">
                ...
                />
                <p v-if="errors.contact" class="error-message">
                  <svg class="error-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  {{ errors.contact }}
        ...
        <div class="modal-footer">
          ...
          <div class="footer-actions">
            ...
            >
              ...
              <div v-else class="btn-content-wrapper">
...
// Separate ref for the Pre-App Search Field
const preAppRef = ref('')
...
const handleSubmit = async () => {
  ...
  // Simulate API call to save initial data
  setTimeout(() => {
    const payload = {
      ...form,
      fullName: `${form.firstName} ${form.middleName} ${form.surname} ${form.ext}`.trim().replace(/\s+/g, ' '),
      referenceNumber: referenceNumber.value,
      // Include the pre-app reference if it was entered
      preApplicationReference: preAppRef.value,
      createdAt: new Date().toISOString()
    }
    
    console.log('Client Record Saved, Proceeding:', payload)
    isSubmitting.value = false
    showSuccess.value = true
    
    // Slight delay to show "Saved" state before Redirecting
    setTimeout(() => {
      // Emitting 'proceed' instead of 'done'
      // The parent component should listen for @proceed and swap the component to ClientBeneficiaryV2.vue
...
.header-search-input {
  ...
  padding: 0.5rem 0.75rem 0.5rem 2.25rem; /* Padding left for icon */
  color: white;
  font-size: 0.875rem;
  outline: none;
  transition: all 0.2s;
...
/* Spinner for the success/redirect banner */
.spinner-small {
  width: 1.25rem;
  height: 1.25rem;
...
.field-readonly { background-color: #f3f4f6; color: #6b7280; cursor: not-allowed; }
...
@media (max-width: 768px) {
  ...
  /* Stack the header search on mobile */
  .modal-header { flex-direction: column; gap: 1rem; align-items: stretch; }
